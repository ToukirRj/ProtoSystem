                ...
                <div className="mx-auto px-4 md:px-12 xl:max-w-7xl xl:px-0">
                    <div className="grid md:grid-cols-12 grid-cols-1 mb-3 items-center">
                        <div className="col-span-3">
                            <div className="md:ps-4 ps-0 mt-0 md:text-start text-center" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                                <h2 className="xl:text-[51px] text-[37px] font-bold text-[#1F2937] dark:text-white leading-[53px]">Effective  
                                ...
                                <p className='mt-1 text-[#1F2937] dark:text-white md:text-[17px] text-[16px] font-[300] tracking-wide leading-[27px]'>My unique strategy that makes the target more specific</p>
                        ...
                        <div className="col-span-9" data-aos="fade-up" data-aos-duration="400" data-aos-delay="200">
                            <div className='py-8 md:px-10 px-3 rounded-[45px] bg-white/[0.2] border border-white/[0.15] dark:bg-white/[.05] dark:border-0'>
                                <div className='flex md:flex-row flex-col justify-between md:items-center items-center'>
                                    <h2 className="text-[26px] font-[600] tracking-tight text-[#1F2937] dark:text-white">Inner latent behave</h2>
                                    <div className='md:flex table text-center flex-row text-[14px] font-[500] text-[#1F2937] dark:text-white tracking-wide gap-2'>
                                        <div className='md:mx-0 mx-1 md:my-0 my-1 h-[30px] px-4 w-auto rounded-[30px] md:flex inline-flex items-center bg-white/[.45] dark:bg-white/[.1]'>
                                            <p>Accessible</p>
                                        </div>
                                        <div className='md:mx-0 mx-1 md:my-0 my-1 h-[30px] px-4 w-auto rounded-[30px] md:flex inline-flex items-center bg-white/[.45] dark:bg-white/[.1]'>
                                            <p>Collaborative</p>
                                ...
                                <div className="flex items-center md:flex-row flex-col md:px-0 px-[20px]">
                                    ...
                                    <div className="lg:w-10/12 md:1/2 w-full">
                                        <p className="mt-4 md:ps-5 ps-0 text-[13px] font-[400] text-[#1F2937]/[0.9] dark:text-white/[.75] tracking-[0.45px] leading-[22px] md:text-justify text-center"> 
                    ...
                    <div className="grid md:grid-cols-4 grid-cols-1 gap-3">
                        {statisticData.map(statistic => (
                            <div key={statistic.id} className="relative overflow-hidden rounded-[40px] bg-white/[0.2] border border-white/[0.15] dark:bg-white/[.05] dark:border-0" data-aos="fade-up" data-aos-duration="400" data-aos-delay="300">
                                <div className='flex flex-row items-center justify-between p-2'>
                                    <span className="ms-5 block w-max text-[13px] font-medium uppercase tracking-wider text-[#1F2937] dark:text-white">{statistic.label}</span>
                                    <div className="h-14 w-14 rounded-full bg-white/[.35] dark:bg-white/[.1] flex items-center justify-center">
                                        <svg className='dark:stroke-white' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={statistic.iconColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" dangerouslySetInnerHTML={{ __html: statistic.iconPath }} />
                                    </div>
                                </div>
                                <h2 className="ms-7 -mt-[1.25rem] md:text-[46px] text-[40px] leading-[46px] font-bold text-[#1F2937] dark:text-white">{statistic.value}</h2>
