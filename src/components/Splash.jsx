                            ...
                            <div className="flex justify-center">
                                <a href="#about" className='table'>
                                    <svg className="mouse" width="40px" viewBox="0 0 247 390" xmlns="http://www.w3.org/2000/svg">
                                        <path className='dark:stroke-white' id="wheel" d="M123.359,79.775l0,72.843" fill="none" stroke="#1F2937" strokeWidth="10px"/>
                                        <path className='dark:stroke-white' id="mouse" d="M236.717,123.359c0,-62.565 -50.794,-113.359 -113.358,-113.359c-62.565,0 -113.359,50.794 -113.359,113.359l0,143.237c0,62.565 50.794,113.359 113.359,113.359c62.564,0 113.358,-50.794 113.358,-113.359l0,-143.237Z" fill="none" stroke="#1F2937" strokeWidth="10px" />
                                    </svg>
                                </a>
                            </div>
                        </div>
