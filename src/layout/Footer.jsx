        ...
        <>
            <footer className="md:mt-12 mt-6">
                <div className="md:mb-20 mb-10 relative mx-auto max-w-full lg:max-w-6xl md:px-0 px-4">
                    <div className='text-center md:py-12 py-7 md:px-8 px-5 w-full bg-white/[0.18] border border-white/[.15] dark:bg-white/[.05] dark:border-0 rounded-[55px] overflow-hidden' data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                        <div className='grid md:grid-cols-5 grid-cols-1 md:place-items-center place-items-inherit'>
                            ...
                            <div className='md:col-span-3 col-span-1'>
                                <div className='relative w-full text-center' data-aos="fade-up" data-aos-duration="700" data-aos-delay="100">
                                    <span className="bg-[#1F2937] dark:bg-white/[.1] text-[#fff] text-[13px] font-[400] tracking-wider px-4 py-1 rounded-full table md:mx-0 mx-auto">Quick Project Contract</span>
                                    <h2 className="my-3 md:text-[45px] text-[21px] md:text-start text-center md:font-bold font-[700] md:leading-[52px] leading-[30px] text-[#1F2937] dark:text-white w-full max-w-5xl mx-auto">
                                        One step to connect with me from everywhere
                                    </h2>
                                    <p className='text-[15px] leading-[27px] font-[400] tracking-wide text-[#1F2937] dark:text-white/[0.7] md:text-start text-center mb-[25px]'>
                ...
                <div className='md:py-16 py-12 bg-white/[0.25] border-t border-white/[0.15] dark:bg-white/[.05] dark:border-0'>
                    <div className="relative mx-auto px-4 md:max-w-full md:px-12 lg:max-w-6xl xl:px-0">
                        <div className='flex flex-col items-center justify-center' data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                            <h1 className="md:text-[21px] text-[19px] font-semibold tracking-tight text-[#1f2937] dark:text-white mb-2">Get Me Connect Now on</h1>
                            <div className='mt-3 md:w-auto w-full'>
                                   ...
                                   <div className="flex md:flex-row flex-col items-center justify-center gap-2 mx-auto">
                                        {socialLinksData.map(link => (
                                            <Link key={link.id} to={link.url} target={link.target}
                                                className="px-2 md:w-auto w-full h-[58px] flex items-center md:justify-center justify-between bg-white/[0.35] hover:bg-white/[0.75] dark:bg-white/[.05] dark:border-0 dark:hover:bg-white/[0.15] rounded-[70px] hover:shadow-lg transition-all border border-white/[0.25]">
                                                ...
                                                <span className='h-11 w-11 flex items-center justify-center bg-transparent rounded-full border border-[#1f2937]/[0.13] dark:bg-white/[.1] dark:border-0'>
                        ...
                        <div className="mt-5 mx-auto max-w-6xl w-full text-[#1f2937] dark:text-white/[0.5] tracking-normal text-[12px] font-[500] text-center md:mb-0 mb-6">
