...
import ThemeToggle from '../props/ThemeToggle';
...
function Header({ onToggleOffCanvas }) {
    ...
    return (
        <header className='header fixed w-full px-4 z-30 left-0 top-0 right-0 my-0 h-[60px] bg-white/[.2] dark:bg-white/[.05] backdrop-blur-[300px] shadow'>
            <div className='px-0 sm:px-12 w-full xl:px-0 max-w-7xl mx-auto'>
                <div className='relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 py-2'>
                    <div className='flex items-center'>
                        <Link to="/"><img src={logo} className='sm:w-[57px] w-[44px] me-5' alt='logo'/></Link>
                    ...
                    <div className='flex items-center'>
                        ...
                        <Link onClick={onToggleOffCanvas}
                            className="relative h-[32px] py-1 px-4 before:absolute before:inset-0 before:rounded-full before:transition-transform before:duration-300 hover:before:scale-110 before:bg-gradient-to-r from-[#ff8144] to-[#17b057]">
